...
void main() {
	vec2 pos = positions[bitfieldExtract(in_vertex.x, 0, 3)] * vec2(pc.glyph_width, pc.glyph_height);
	vec2 offset = vec2(bitfieldExtract(in_vertex.y, 0, 16), bitfieldExtract(in_vertex.y, 16, 16)) * vec2(pc.glyph_width, pc.glyph_height);
